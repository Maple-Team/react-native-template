...
export default class JPush {
   ...
   * */
  static setLoggerEnable(enable: boolean) {
   ...
   * */
  static getRegistrationID(callback: any) {
    if (Platform.OS === 'android') {
   ...
   * */
  static setMobileNumber(params: any) {
    if (Platform.OS === 'android') {
   ...
   * */
  static setPowerSaveMode(enable: any) {
    if (Platform.OS === 'android') {
   ...
   *   检查当前应用的通知开关是否开启
   * */
  static isNotificationEnabled(callback: any) {
    if (Platform.OS === 'android') {
   ...
   *
   * */
  static addLocalNotification(params: any) {
    if (Platform.OS === 'android') {
   ...
   *
   * */
  static removeLocalNotification(params: any) {
    if (Platform.OS === 'android') {
   ...
   *  删除指定的通知
   * */
  static clearNotificationById(params: any) {
    if (Platform.OS === 'android') {
   ...
   * */
  static setMaxGeofenceNumber(params: any) {
    if (Platform.OS === 'android') {
   ...
   * 删除指定id的地理围栏
   * */
  static deleteGeofence(params: any) {
    if (Platform.OS === 'android') {
  ...
  //连接状态
  static addConnectEventListener(callback: string | number) {
   ...
   *
   * */
  static addNotificationListener(callback: string | number) {
   ...
   *
   * */
  static addLocalNotificationListener(callback: string | number) {
   ...
   *
   * */
  static addCustomMessageListener(callback: string | number) {
   ...
   *
   * */
  static addTagAliasListener(callback: string | number) {
   ...
   *
   * */
  static addMobileNumberListener(callback: string | number) {
  ...
  //移除事件
  static removeListener(callback: string | number) {
   ...
   * */
  static isPushStopped(callback: any) {
    if (Platform.OS === 'android') {
   ...
   * */
  static setSilenceTime(params: any) {
    if (Platform.OS === 'android') {
   ...
   * */
  static setLatestNotificationNumber(params: any) {
    if (Platform.OS === 'android') {
