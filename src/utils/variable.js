...
export default {
  ...
  PermissionContent: {
    location: {
      ...
      hint:
        'Please allow us for accessing your Location, your privacy security will be under strict protection;',
    },
    phone: {
      name: 'device',
      ...
      hint:
        'Please allow us for accessing your Device, your privacy security will be under strict protection;',
    },
    contacts: {
      name: 'contacts',
      permissionName:
      ...
      hint:
        'Please allow us for accessing your Contacts, your privacy security will be under strict protection;',
    },
    camera: {
      name: 'camera',
      permissionName:
      ...
      hint:
        'Please allow us for accessing your Camera, your privacy security will be under strict protection;',
    },
    file: {
      name: 'file',
      ...
      content: '',
      hint:
        'Please allow us for accessing your Files, your privacy security will be under strict protection;',
    },
  },
