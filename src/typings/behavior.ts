...
export type InputTypeID =
  ...
  // | 'P01_C15_I_FACEBOOK'
  | 'P02_C02_I_company'
  | 'P02_C03_I_companyPhone' // P02
  | 'P03_C01_I_contactName'
  | 'P03_C02_I_CONTACTPHONE'
  | 'P03_C03_I_contactName'
  | 'P03_C04_I_CONTACTPHONE'
  | 'P03_C05_I_contactName'
  | 'P03_C06_I_CONTACTPHONE' // P03
...
export type SelectTypeID =
  ...
  | 'P02_C0x_S_jobTypeCode'
  | 'P02_C0x_S_MONTHLYINCOME'
  | 'P02_C0x_S_SALARYTYPE'
  | 'P02_C0x_S_STATE'
  | 'P02_C0x_S_CITY'
  | 'P02_C0x_S_incumbency' // P02
  | 'P03_C01_S_RELATIONSHIP'
  | 'P03_C02_S_RELATIONSHIP'
  | 'P03_C03_S_RELATIONSHIP' // P03
  | 'P04_C01_S_BANKNAME'
  | 'P04_C98_B_MODIFY'
  | 'P05_C01_B_IDCARD'
  | 'P05_C01_E_EXIF'
